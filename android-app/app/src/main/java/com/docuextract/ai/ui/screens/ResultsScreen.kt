...
import com.docuextract.ai.data.models.ExtractionResult
import com.docuextract.ai.data.models.ProcessingStatus
...
fun ResultItem(
    ...
    fields: List<com.docuextract.ai.data.models.TemplateField>
) {
